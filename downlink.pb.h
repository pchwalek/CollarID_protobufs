...
typedef enum _CommandType {
 ...
 prerequisite for building delta fragments. */
    CommandType_CMD_CONFIG_REPORT = 16 /* Uplink current schedule config */
} CommandType;
...
#define _CommandType_MAX CommandType_CMD_CONFIG_REPORT
#define _CommandType_ARRAYSIZE ((CommandType)(CommandType_CMD_CONFIG_REPORT+1))
...
#define DownlinkPacket_init_default              {0, _CommandType_MIN, false, HighFixParams_init_default, false, GeofenceData_init_default, false, ConfigFragment_init_default, false, 0, false, 0, false, 0, false, 0}
...
#define DownlinkPacket_init_zero                 {0, _CommandType_MIN, false, HighFixParams_init_zero, false, GeofenceData_init_zero, false, ConfigFragment_init_zero, false, 0, false, 0, false, 0, false, 0}
...
#define DownlinkPacket_cfg_txn_id_tag            9
...
#define DownlinkPacket_size                      298
